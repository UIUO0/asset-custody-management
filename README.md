...
**منصّة داخلية لتتبّع الأصناف والعُهد والحجوزات — عربية بالكامل، تعمل على البنية التحتية للهيئة.**
...
نظام إدارة الأصناف هو منصّة داخلية تتيح للهيئة معرفة **ما تملكه، وأين هو، ومن بحوزته** — في أي لحظة.

يغطي النظام دورة حياة الصنف كاملة: من التسجيل والترميز بـ QR، مرورًا بإسناد العُهدة والحجز والصيانة، وصولًا إلى الجرد والتقارير. الواجهة **عربية بالكامل باتجاه RTL**، وتحمل الهوية البصرية للهيئة، ولا تعتمد على أي خدمة سحابية خارجية في وضع التشغيل الداخلي.

### لماذا هذا النظام

| التحدي                                    | ما يقدّمه النظام                                           |
| ----------------------------------------- | ---------------------------------------------------------- |
| الأصناف موزّعة على مواقع ولا حصر دقيق لها | سجل مركزي واحد مع مواقع هرمية (مبنى ← دور ← غرفة ← رف)     |
...
**إدارة الأصناف** — تسجيل الأصناف مع حقول مخصّصة (تاريخ الشراء، الرقم التسلسلي، الضمان، الحالة)، وتصنيفات ووسوم مرنة، وحُزم (Kits) لتجميع الأصناف المترابطة كوحدة واحدة.

**الترميز والمسح** — توليد وطباعة رموز QR وباركود، ومسحها من أي جوال لعرض الصنف أو تسليمه أو الإبلاغ عنه. يدعم الماسح العمليات الجماعية: إسناد عُهدة، تحديث موقع، إضافة لحجز.

**العُهد والحجوزات** — إسناد الأصناف للموظفين مع معرفة دقيقة بمن يحمل ماذا، ونظام حجز بتقويم مع تواريخ تسليم واستلام ومنع تعارض.

**التنظيم والبحث** — بحث نصي كامل مع فلاتر متقدّمة وقوالب فلترة محفوظة، واستيراد وتصدير CSV للعمليات الجماعية.

**الحوكمة** — أدوار صلاحيات متدرّجة (مالك، مدير، مستخدم، خدمة ذاتية)، وعزل كامل للبيانات بين مساحات العمل، وسجل تدقيق وملاحظات على كل صنف.

**تطبيق الجوال المرافق** — تطبيق iOS و Android للمسح الميداني وإدارة الأصناف والجرد والحجوزات.
...
│   │       ├── modules/     # منطق الأعمال (أصناف، عُهد، استلام)
...
هذا النظام مبني على **[Shelf.nu](https://www.shelf.nu/)** — منصّة إدارة أصناف مفتوحة المصدر، مرخّصة بموجب **[GNU AGPL-3.0](./LICENSE)**.
