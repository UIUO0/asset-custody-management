...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        /**
         * Surface/text palette is driven by CSS variables defined in
         * `app/styles/global.css`, which the `.dark` block re-points. That is
         * what gives the whole app dark mode without per-component `dark:`
         * variants. See the comment block there for the rationale.
         */
        white: "rgb(var(--color-white) / <alpha-value>)",
        /** Never inverts — for text/icons on a colored (brand) background. */
        "static-white": "#ffffff",
        black: "#000000",
