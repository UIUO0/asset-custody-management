...
type RouteFiles = {
  ...
  "routes/api+/assets.bulk-approve.ts": {
    id: "routes/api+/assets.bulk-approve";
    page: "/api/assets/bulk-approve";
  };
...
type RouteModules = {
  ...
  "routes/api+/assets.bulk-approve": typeof import("./app/routes/api+/assets.bulk-approve.ts");
