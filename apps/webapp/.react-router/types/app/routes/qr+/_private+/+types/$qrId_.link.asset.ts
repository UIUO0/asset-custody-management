...
type Module = typeof import("../$qrId_.link.asset.js")

type Info = GetInfo<{
  file: "routes/qr+/_private+/$qrId_.link.asset.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../$qrId_.link.js");
}, {
  id: "routes/qr+/_private+/$qrId_.link.asset";
  module: typeof import("../$qrId_.link.asset.js");
}];
