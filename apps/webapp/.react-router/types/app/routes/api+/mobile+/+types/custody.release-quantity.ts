...
type Module = typeof import("../custody.release-quantity.js")

type Info = GetInfo<{
  file: "routes/api+/mobile+/custody.release-quantity.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../custody.release-quantity.js");
}];
