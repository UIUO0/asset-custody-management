...
type Module = typeof import("../asset.refresh-image.$assetId.js")

type Info = GetInfo<{
  file: "routes/api+/mobile+/asset.refresh-image.$assetId.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../asset.refresh-image.$assetId.js");
}];
