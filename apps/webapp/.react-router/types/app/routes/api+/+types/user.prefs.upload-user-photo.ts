...
type Module = typeof import("../user.prefs.upload-user-photo.js")

type Info = GetInfo<{
  file: "routes/api+/user.prefs.upload-user-photo.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../user.prefs.upload-user-photo.js");
}];
