...
type Module = typeof import("../$organizationId.qr-codes[.zip].js")

type Info = GetInfo<{
  file: "routes/api+/$organizationId.qr-codes[.zip].ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../$organizationId.qr-codes[.zip].js");
}];
