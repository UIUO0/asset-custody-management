...
type Module = typeof import("../user.change-current-organization.js")

type Info = GetInfo<{
  file: "routes/api+/user.change-current-organization.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../user.change-current-organization.js");
}];
