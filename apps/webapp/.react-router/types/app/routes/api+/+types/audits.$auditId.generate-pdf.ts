...
type Module = typeof import("../audits.$auditId.generate-pdf.js")

type Info = GetInfo<{
  file: "routes/api+/audits.$auditId.generate-pdf.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../audits.$auditId.generate-pdf.js");
}];
