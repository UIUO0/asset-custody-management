...
type Module = typeof import("../kits.$kitId.generate-code-obj.js")

type Info = GetInfo<{
  file: "routes/api+/kits.$kitId.generate-code-obj.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../kits.$kitId.generate-code-obj.js");
}];
