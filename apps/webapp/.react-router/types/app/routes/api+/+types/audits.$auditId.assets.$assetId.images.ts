...
type Module = typeof import("../audits.$auditId.assets.$assetId.images.js")

type Info = GetInfo<{
  file: "routes/api+/audits.$auditId.assets.$assetId.images.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../audits.$auditId.assets.$assetId.images.js");
}];
