...
type Module = typeof import("../reports.$reportId.generate-pdf.js")

type Info = GetInfo<{
  file: "routes/api+/reports.$reportId.generate-pdf.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../reports.$reportId.generate-pdf.js");
}];
