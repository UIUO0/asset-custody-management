...
type Module = typeof import("../settings.export-nrm.$fileName[.csv].js")

type Info = GetInfo<{
  file: "routes/api+/settings.export-nrm.$fileName[.csv].ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.export-nrm.$fileName[.csv].js");
}];
