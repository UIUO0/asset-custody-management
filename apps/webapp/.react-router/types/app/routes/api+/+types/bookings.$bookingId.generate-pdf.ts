...
type Module = typeof import("../bookings.$bookingId.generate-pdf.js")

type Info = GetInfo<{
  file: "routes/api+/bookings.$bookingId.generate-pdf.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.generate-pdf.js");
}];
