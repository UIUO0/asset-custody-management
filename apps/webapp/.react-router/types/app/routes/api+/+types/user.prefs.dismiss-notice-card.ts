...
type Module = typeof import("../user.prefs.dismiss-notice-card.js")

type Info = GetInfo<{
  file: "routes/api+/user.prefs.dismiss-notice-card.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../user.prefs.dismiss-notice-card.js");
}];
