...
type Module = typeof import("../$organizationId.working-hours.js")

type Info = GetInfo<{
  file: "routes/api+/$organizationId.working-hours.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../$organizationId.working-hours.js");
}];
