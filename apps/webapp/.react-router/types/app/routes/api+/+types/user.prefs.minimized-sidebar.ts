...
type Module = typeof import("../user.prefs.minimized-sidebar.js")

type Info = GetInfo<{
  file: "routes/api+/user.prefs.minimized-sidebar.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../user.prefs.minimized-sidebar.js");
}];
