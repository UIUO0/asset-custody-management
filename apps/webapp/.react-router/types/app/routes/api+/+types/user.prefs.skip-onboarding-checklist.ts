...
type Module = typeof import("../user.prefs.skip-onboarding-checklist.js")

type Info = GetInfo<{
  file: "routes/api+/user.prefs.skip-onboarding-checklist.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../user.prefs.skip-onboarding-checklist.js");
}];
