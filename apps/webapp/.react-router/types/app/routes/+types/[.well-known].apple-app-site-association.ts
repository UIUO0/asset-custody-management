...
type Module = typeof import("../[.well-known].apple-app-site-association.js")

type Info = GetInfo<{
  file: "routes/[.well-known].apple-app-site-association.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../[.well-known].apple-app-site-association.js");
}];
