...
type Module = typeof import("../org.$organizationId.qr-codes.js")

type Info = GetInfo<{
  file: "routes/_layout+/admin-dashboard+/org.$organizationId.qr-codes.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../org.$organizationId.qr-codes.js");
}];
