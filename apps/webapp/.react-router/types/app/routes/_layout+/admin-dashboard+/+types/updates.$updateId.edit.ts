...
type Module = typeof import("../updates.$updateId.edit.js")

type Info = GetInfo<{
  file: "routes/_layout+/admin-dashboard+/updates.$updateId.edit.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../updates.js");
}, {
  id: "routes/_layout+/admin-dashboard+/updates.$updateId.edit";
  module: typeof import("../updates.$updateId.edit.js");
}];
