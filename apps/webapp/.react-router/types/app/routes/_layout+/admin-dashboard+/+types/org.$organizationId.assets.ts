...
type Module = typeof import("../org.$organizationId.assets.js")

type Info = GetInfo<{
  file: "routes/_layout+/admin-dashboard+/org.$organizationId.assets.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../org.$organizationId.assets.js");
}];
