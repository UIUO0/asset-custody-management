...
type Module = typeof import("../qrs.codes[.zip].js")

type Info = GetInfo<{
  file: "routes/_layout+/admin-dashboard+/qrs.codes[.zip].ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../qrs.js");
}, {
  id: "routes/_layout+/admin-dashboard+/qrs.codes[.zip]";
  module: typeof import("../qrs.codes[.zip].js");
}];
