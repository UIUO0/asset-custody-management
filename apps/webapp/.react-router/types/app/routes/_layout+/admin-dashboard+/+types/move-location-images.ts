...
type Module = typeof import("../move-location-images.js")

type Info = GetInfo<{
  file: "routes/_layout+/admin-dashboard+/move-location-images.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../move-location-images.js");
}];
