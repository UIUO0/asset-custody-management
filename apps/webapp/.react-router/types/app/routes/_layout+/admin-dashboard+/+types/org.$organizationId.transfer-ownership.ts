...
type Module = typeof import("../org.$organizationId.transfer-ownership.js")

type Info = GetInfo<{
  file: "routes/_layout+/admin-dashboard+/org.$organizationId.transfer-ownership.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../org.$organizationId.js");
}, {
  id: "routes/_layout+/admin-dashboard+/org.$organizationId.transfer-ownership";
  module: typeof import("../org.$organizationId.transfer-ownership.js");
}];
