...
type Module = typeof import("../org.$organizationId.members.js")

type Info = GetInfo<{
  file: "routes/_layout+/admin-dashboard+/org.$organizationId.members.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../org.$organizationId.members.js");
}];
