...
type Module = typeof import("../settings.team.users.$userId.note.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.team.users.$userId.note.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.team.users.$userId.note.js");
}];
