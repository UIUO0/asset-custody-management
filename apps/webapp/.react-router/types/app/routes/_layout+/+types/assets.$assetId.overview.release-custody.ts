...
type Module = typeof import("../assets.$assetId.overview.release-custody.js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.$assetId.overview.release-custody.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.$assetId.overview.release-custody.js");
}];
