...
type Module = typeof import("../settings.team.users.$userId.bookings.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.team.users.$userId.bookings.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.team.js");
}, {
  id: "routes/_layout+/settings.team.users";
  module: typeof import("../settings.team.users.js");
}, {
  id: "routes/_layout+/settings.team.users.$userId";
  module: typeof import("../settings.team.users.$userId.js");
}, {
  id: "routes/_layout+/settings.team.users.$userId.bookings";
  module: typeof import("../settings.team.users.$userId.bookings.js");
}];
