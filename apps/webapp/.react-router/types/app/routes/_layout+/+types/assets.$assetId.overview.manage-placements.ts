...
type Module = typeof import("../assets.$assetId.overview.manage-placements.js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.$assetId.overview.manage-placements.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.$assetId.overview.manage-placements.js");
}];
