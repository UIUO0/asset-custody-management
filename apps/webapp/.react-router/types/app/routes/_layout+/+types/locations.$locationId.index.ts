...
type Module = typeof import("../locations.$locationId.index.js")

type Info = GetInfo<{
  file: "routes/_layout+/locations.$locationId.index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../locations.$locationId.index.js");
}];
