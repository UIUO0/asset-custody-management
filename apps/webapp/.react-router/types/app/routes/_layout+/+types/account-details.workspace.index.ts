...
type Module = typeof import("../account-details.workspace.index.js")

type Info = GetInfo<{
  file: "routes/_layout+/account-details.workspace.index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../account-details.workspace.index.js");
}];
