...
type Module = typeof import("../bookings.$bookingId.overview.manage-assets.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.overview.manage-assets.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.overview.manage-assets.js");
}];
