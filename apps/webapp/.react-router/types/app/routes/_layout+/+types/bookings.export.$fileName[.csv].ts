...
type Module = typeof import("../bookings.export.$fileName[.csv].js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.export.$fileName[.csv].tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.export.$fileName[.csv].js");
}];
