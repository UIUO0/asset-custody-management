...
type Module = typeof import("../settings.team.users.$userId.notes.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.team.users.$userId.notes.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.team.users.$userId.notes.js");
}];
