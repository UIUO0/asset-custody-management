...
type Module = typeof import("../settings.team.users.$userId.assets.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.team.users.$userId.assets.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.team.users.$userId.assets.js");
}];
