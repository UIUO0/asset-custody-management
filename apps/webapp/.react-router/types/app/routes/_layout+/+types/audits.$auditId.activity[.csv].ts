...
type Module = typeof import("../audits.$auditId.activity[.csv].js")

type Info = GetInfo<{
  file: "routes/_layout+/audits.$auditId.activity[.csv].ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../audits.$auditId.activity[.csv].js");
}];
