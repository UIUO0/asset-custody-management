...
type Module = typeof import("../locations.$locationId_.edit.js")

type Info = GetInfo<{
  file: "routes/_layout+/locations.$locationId_.edit.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../locations.$locationId_.edit.js");
}];
