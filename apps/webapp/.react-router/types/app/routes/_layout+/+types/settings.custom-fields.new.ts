...
type Module = typeof import("../settings.custom-fields.new.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.custom-fields.new.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.custom-fields.new.js");
}];
