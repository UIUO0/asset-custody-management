...
type Module = typeof import("../locations.$locationId.activity[.csv].js")

type Info = GetInfo<{
  file: "routes/_layout+/locations.$locationId.activity[.csv].ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../locations.$locationId.activity[.csv].js");
}];
