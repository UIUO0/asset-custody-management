...
type Module = typeof import("../assets.$assetId.overview.add-to-existing-booking.js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.$assetId.overview.add-to-existing-booking.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.$assetId.js");
}, {
  id: "routes/_layout+/assets.$assetId.overview";
  module: typeof import("../assets.$assetId.overview.js");
}, {
  id: "routes/_layout+/assets.$assetId.overview.add-to-existing-booking";
  module: typeof import("../assets.$assetId.overview.add-to-existing-booking.js");
}];
