...
type Module = typeof import("../settings.asset-models.index.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.asset-models.index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.asset-models.index.js");
}];
