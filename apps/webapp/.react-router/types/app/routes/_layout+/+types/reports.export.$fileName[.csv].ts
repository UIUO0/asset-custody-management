...
type Module = typeof import("../reports.export.$fileName[.csv].js")

type Info = GetInfo<{
  file: "routes/_layout+/reports.export.$fileName[.csv].tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../reports.export.$fileName[.csv].js");
}];
