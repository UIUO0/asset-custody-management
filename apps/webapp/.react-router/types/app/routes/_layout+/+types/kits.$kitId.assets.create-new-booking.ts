...
type Module = typeof import("../kits.$kitId.assets.create-new-booking.js")

type Info = GetInfo<{
  file: "routes/_layout+/kits.$kitId.assets.create-new-booking.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../kits.$kitId.assets.create-new-booking.js");
}];
