...
type Module = typeof import("../categories.$categoryId_.edit.js")

type Info = GetInfo<{
  file: "routes/_layout+/categories.$categoryId_.edit.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../categories.$categoryId_.edit.js");
}];
