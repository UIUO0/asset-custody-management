...
type Module = typeof import("../bookings.$bookingId.overview.checkin-assets.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.overview.checkin-assets.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.overview.checkin-assets.js");
}];
