...
type Module = typeof import("../kits.$kitId.assets.update-location.js")

type Info = GetInfo<{
  file: "routes/_layout+/kits.$kitId.assets.update-location.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../kits.$kitId.assets.update-location.js");
}];
