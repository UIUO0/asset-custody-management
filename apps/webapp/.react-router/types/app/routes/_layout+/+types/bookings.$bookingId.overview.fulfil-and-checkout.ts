...
type Module = typeof import("../bookings.$bookingId.overview.fulfil-and-checkout.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.overview.fulfil-and-checkout.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.overview.js");
}, {
  id: "routes/_layout+/bookings.$bookingId.overview.fulfil-and-checkout";
  module: typeof import("../bookings.$bookingId.overview.fulfil-and-checkout.js");
}];
