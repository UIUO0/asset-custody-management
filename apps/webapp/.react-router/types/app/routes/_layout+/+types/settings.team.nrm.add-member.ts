...
type Module = typeof import("../settings.team.nrm.add-member.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.team.nrm.add-member.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.team.nrm.add-member.js");
}];
