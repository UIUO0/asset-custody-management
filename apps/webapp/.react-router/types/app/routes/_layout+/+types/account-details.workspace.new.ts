...
type Module = typeof import("../account-details.workspace.new.js")

type Info = GetInfo<{
  file: "routes/_layout+/account-details.workspace.new.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../account-details.workspace.new.js");
}];
