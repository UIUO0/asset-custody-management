...
type Module = typeof import("../bookings.$bookingId.overview.cal[.ics].js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.overview.cal[.ics].ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.overview.cal[.ics].js");
}];
