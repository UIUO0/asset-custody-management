...
type Module = typeof import("../assets.$assetId.overview.duplicate.js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.$assetId.overview.duplicate.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.$assetId.overview.duplicate.js");
}];
