...
type Module = typeof import("../assets.$assetId.overview.update-location.js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.$assetId.overview.update-location.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.$assetId.overview.update-location.js");
}];
