...
type Module = typeof import("../assets.export.$fileName[.csv].js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.export.$fileName[.csv].tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.export.$fileName[.csv].js");
}];
