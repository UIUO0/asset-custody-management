...
type Module = typeof import("../assets.$assetId.activity[.csv].js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.$assetId.activity[.csv].ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.$assetId.activity[.csv].js");
}];
