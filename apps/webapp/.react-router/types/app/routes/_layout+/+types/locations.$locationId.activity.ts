...
type Module = typeof import("../locations.$locationId.activity.js")

type Info = GetInfo<{
  file: "routes/_layout+/locations.$locationId.activity.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../locations.$locationId.activity.js");
}];
