...
type Module = typeof import("../assets.$assetId.overview.assign-custody.js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.$assetId.overview.assign-custody.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.$assetId.overview.assign-custody.js");
}];
