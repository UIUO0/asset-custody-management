...
type Module = typeof import("../bookings.$bookingId.activity[.csv].js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.activity[.csv].ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.activity[.csv].js");
}];
