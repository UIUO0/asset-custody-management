...
type Module = typeof import("../settings.asset-models.new.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.asset-models.new.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.asset-models.new.js");
}];
