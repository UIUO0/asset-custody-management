...
type Module = typeof import("../bookings.$bookingId.overview.manage-kits.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.overview.manage-kits.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.overview.manage-kits.js");
}];
