...
type Module = typeof import("../locations.$locationId.note.js")

type Info = GetInfo<{
  file: "routes/_layout+/locations.$locationId.note.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../locations.$locationId.note.js");
}];
