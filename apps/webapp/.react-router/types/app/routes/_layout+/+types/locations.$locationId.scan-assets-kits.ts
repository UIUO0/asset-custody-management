...
type Module = typeof import("../locations.$locationId.scan-assets-kits.js")

type Info = GetInfo<{
  file: "routes/_layout+/locations.$locationId.scan-assets-kits.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../locations.$locationId.scan-assets-kits.js");
}];
