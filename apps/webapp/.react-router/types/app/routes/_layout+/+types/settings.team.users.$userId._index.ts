...
type Module = typeof import("../settings.team.users.$userId._index.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.team.users.$userId._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.team.users.$userId._index.js");
}];
