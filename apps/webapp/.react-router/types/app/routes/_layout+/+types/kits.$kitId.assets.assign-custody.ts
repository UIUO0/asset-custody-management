...
type Module = typeof import("../kits.$kitId.assets.assign-custody.js")

type Info = GetInfo<{
  file: "routes/_layout+/kits.$kitId.assets.assign-custody.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../kits.$kitId.assets.assign-custody.js");
}];
