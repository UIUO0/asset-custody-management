...
type Module = typeof import("../bookings.$bookingId._index.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId._index.js");
}];
