...
type Module = typeof import("../bookings.$bookingId.overview.checkout-assets.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.overview.checkout-assets.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.overview.checkout-assets.js");
}];
