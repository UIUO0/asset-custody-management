...
type Module = typeof import("../locations.$locationId.overview.js")

type Info = GetInfo<{
  file: "routes/_layout+/locations.$locationId.overview.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../locations.$locationId.overview.js");
}];
