...
type Module = typeof import("../kits.$kitId.assets.manage-assets.js")

type Info = GetInfo<{
  file: "routes/_layout+/kits.$kitId.assets.manage-assets.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../kits.$kitId.assets.manage-assets.js");
}];
