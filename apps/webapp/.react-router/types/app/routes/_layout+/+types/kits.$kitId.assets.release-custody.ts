...
type Module = typeof import("../kits.$kitId.assets.release-custody.js")

type Info = GetInfo<{
  file: "routes/_layout+/kits.$kitId.assets.release-custody.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../kits.$kitId.assets.release-custody.js");
}];
