...
type Module = typeof import("../bookings.$bookingId.overview.scan-assets.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.overview.scan-assets.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.overview.scan-assets.js");
}];
