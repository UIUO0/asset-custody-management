...
type Module = typeof import("../bookings.$bookingId.overview.duplicate.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.overview.duplicate.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.overview.duplicate.js");
}];
