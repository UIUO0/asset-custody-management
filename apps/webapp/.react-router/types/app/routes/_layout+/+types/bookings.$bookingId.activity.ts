...
type Module = typeof import("../bookings.$bookingId.activity.js")

type Info = GetInfo<{
  file: "routes/_layout+/bookings.$bookingId.activity.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../bookings.$bookingId.activity.js");
}];
