...
type Module = typeof import("../settings.custom-fields.index.js")

type Info = GetInfo<{
  file: "routes/_layout+/settings.custom-fields.index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../settings.custom-fields.index.js");
}];
