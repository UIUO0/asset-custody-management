...
type Module = typeof import("../assets.$assetId.overview.create-new-booking.js")

type Info = GetInfo<{
  file: "routes/_layout+/assets.$assetId.overview.create-new-booking.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../assets.$assetId.overview.create-new-booking.js");
}];
