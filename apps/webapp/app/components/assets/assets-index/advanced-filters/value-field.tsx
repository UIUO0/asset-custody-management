        ...
        return (
          <div className="relative">
            ...
            <Input
              ...
              error={error}
              inputClassName={tw(commonInputProps.inputClassName, "ps-[44px]")}
            />
          </div>
        );
      }
    ...
    <>
      ...
      >
        <PopoverTrigger asChild>
          ...
          >
            <ChevronRight className="ms-[2px] inline-block rotate-90" />
            <span className="ms-2">{displayValue}</span>
          </Button>
        </PopoverTrigger>
        <PopoverPortal>
          <PopoverContent
        ...
        <div key={entry.id} className="relative flex items-center gap-2">
          ...
          {dates.length > 1 && (
            <Button
              ...
              className="absolute right-0 -me-1 mt-[2px] shrink-0 translate-x-full  bg-white  text-[10px] font-normal text-gray-600"
              icon="x"
