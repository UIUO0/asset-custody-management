      ...
      <span className="word-break mb-1 block">
        ...
        {isQuantityTracked(asset) && qtyBooked > 0 ? (
          qtyDispositioned > 0 ? (
            ...
            // already back in.
            <span className="ms-1.5 inline-flex items-center gap-1 text-xs tabular-nums text-gray-700">
              <span className="font-medium">{qtyCheckedOut}</span>
              <span className="text-gray-400">/ {qtyBooked}</span>
            </span>
          ) : (
            <span className="ms-1.5 text-xs font-medium text-gray-500">
              &times; {qtyBooked}
            </span>
          )
        ) : null}
            ...
            {outstanding.map((req) => (
              ...
              >
                <td className="w-full whitespace-normal p-0 md:p-0">
                  <div className="flex items-center gap-3 px-6 py-4 md:pe-6">
                ...
                <tbody className="">
                  {paginatedItems.map((item) => {
                      ...
                      return (
                        <React.Fragment key={`kit-${item.id}`}>
                          ...
                          <tr className="relative border-b border-gray-200 bg-gray-50">
                            <td className="w-full whitespace-normal p-0 md:p-0">
                              <div className="flex items-center gap-3 px-6 py-4 md:justify-normal md:pe-6">
                                <KitImage
                                  kit={{
                                    image: kit.image,
                            ...
                            <td className="px-6 py-4 pe-4 text-end align-middle">
                            ...
                            item.assets.map((asset) => (
                              ...
                              >
                                <td className="w-full whitespace-normal p-0 md:p-0">
                                  ...
                                  <div className="flex justify-between gap-3 bg-gray-50/50 px-6 py-4 md:justify-normal md:pe-6">
                                ...
                                <td className="bg-gray-50/50 px-6 py-4 pe-4 text-end">
                                  {" "}
                                </td>
                              </tr>
                            ))}
                    ...
                    return (
                      ...
                      >
                        <td className="w-full whitespace-normal p-0 md:p-0">
                          <div className="flex justify-between gap-3 px-6 py-4 md:justify-normal md:pe-6">
                            <div className="flex items-center gap-3">
                              <div className="relative flex size-12 shrink-0 items-center justify-center">
                                <AssetImage
                                  asset={{
                        ...
                        <td className="px-6 py-4 pe-4 text-end"> </td>
                      </tr>
                    );
                  })}
                </tbody>
