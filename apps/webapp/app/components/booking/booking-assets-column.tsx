    ...
    <div className="flex-1">
      <div className="w-full">
        ...
        <div className="flex flex-col">
          ...
          <div className="-mx-4 border border-b-0 bg-white px-4 pb-3 pt-4 text-start font-normal text-gray-600 md:mx-0 md:rounded-t ">
            <BookingAssetsHeader
  ...
  return (
    <tr className="relative border-b border-gray-200">
      {/* Bulk-select cell — empty because models aren't selectable as
          bulk items, but padded with the SAME `md:ps-4 md:pe-3` that
