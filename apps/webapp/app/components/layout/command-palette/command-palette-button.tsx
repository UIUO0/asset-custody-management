  ...
  if (variant === "icon") {
    return (
      <Button
        ...
        aria-label={t("ui.openCommandPalette")}
        variant={"secondary"}
        className={tw(
  ...
  return (
    ...
    >
      <div className="flex w-full items-center gap-2">
        <span className="hidden sm:inline">{t("list.quickFind")}</span>
        <span className="sm:hidden">{t("list.quickFind")}...</span>
        <span className="ms-auto hidden items-center gap-1 rounded bg-gray-50 px-1 text-[10px] font-medium  text-gray-500 md:inline-flex md:border md:border-gray-200">
          {shortcut}
        </span>
      </div>
    </Button>
