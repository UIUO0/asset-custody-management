    ...
    <>
      <Tr key={`reconciled-kit-header-${kit.id}`} skipEntrance>
        <td className="w-full p-0 md:p-0">
          <button
            ...
            aria-expanded={open}
            className="flex w-full items-center justify-between gap-3 p-4 text-start transition hover:bg-gray-50 md:px-6"
          >
      ...
      {open
        ? assets.map((asset) => (
            ...
            >
              <td className="w-full p-0 md:p-0">
                <div className="flex items-center justify-between gap-3 border-l-2 border-gray-200 p-4 ps-8 md:px-6 md:ps-10">
              ...
              <td className="pe-4 text-end md:pe-6">
...
function QuantityDispositionBlock({
  ...
  const numInput = tw(
    "w-14 rounded-md border px-2 py-1 text-end text-sm tabular-nums",
...
function ScannedKitQtyMemberRow({ asset }: { asset: QtyExpectedAsset }) {
  ...
  return (
    <Tr key={`scanned-kit-qty-${asset.bookingAssetId}`} skipEntrance>
      <td className="w-full p-0 md:p-0">
        <div className="flex flex-col gap-3 border-l-2 border-gray-200 p-4 pb-6 ps-8 sm:flex-row sm:items-start sm:justify-between md:px-6 md:pb-6 md:ps-10">
          <div className="flex min-w-0 flex-col gap-1">
            <span className="word-break whitespace-break-spaces text-sm font-medium text-gray-700">
              {asset.title}
            </span>
