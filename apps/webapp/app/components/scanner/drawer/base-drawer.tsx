      ...
      >
        <div className={tw("h-full")} style={style}>
          <div className="mx-auto inline-flex size-full flex-col px-4 ">
            ...
            <div
              ref={baseHeaderRef}
              className="default-base-drawer-header flex items-center justify-between border-b text-start"
            >
            ...
            {!shouldRenderBody ? (
              ...
              <div
                ref={itemsListRef}
                className="-ms-4 flex max-h-full w-screen flex-col overflow-y-scroll md:ms-0 md:w-full"
              >
