  ...
  return (
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <button type="button" aria-label={t("ui.noteActions")}>
          <HorizontalDotsIcon aria-hidden="true" />
        </button>
      </DropdownMenuTrigger>
      <DropdownMenuContent
        align="end"
        className="order w-[180px] rounded bg-white p-1.5 text-end"
      >
        <div className="relative flex select-none items-center rounded p-2 text-start text-[13px] leading-none outline-none data-[highlighted]:bg-gradient-to-br hover:bg-gray-100">
