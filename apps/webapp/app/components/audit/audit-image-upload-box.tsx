    ...
    <div className="group relative size-24 shrink-0 overflow-hidden rounded-lg border-2 border-gray-200">
      ...
      {!disabled && (
        <button
          type="button"
          onClick={onRemove}
          className="absolute right-1 top-1 rounded-full bg-gray-900/70 p-1 text-static-white opacity-0 transition-opacity group-hover:opacity-100 hover:bg-gray-900"
        >
          <X className="size-3" />
        </button>
      )}
          ...
          <div key={image.id} className="group relative size-24 shrink-0">
            ...
            {!disabled && onExistingImageRemove && (
              <button
                ...
                className="absolute right-1 top-1 z-10 rounded-full bg-gray-900/70 p-1 text-static-white opacity-0 transition-opacity group-hover:opacity-100 hover:bg-gray-900"
              >
                <X className="size-3" />
              </button>
            )}
