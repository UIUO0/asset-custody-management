      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="block truncate rounded-sm text-start font-medium text-gray-900 hover:text-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1"
          >
            {title}
          </Link>
        </TooltipTrigger>
