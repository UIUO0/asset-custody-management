  ...
  return (
    <label className="flex flex-col gap-2" htmlFor={htmlFor}>
      <span className="text-sm font-medium text-gray-700">
        {children}
        {required ? <span className="ms-1 text-error-500">*</span> : null}
      </span>
    </label>
  );
}
      ...
      >
        <PopoverTrigger asChild>
          <button
            ...
            tabIndex={0}
            className={tw(
              "flex h-[44px] w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 text-start text-gray-900 hover:border-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary",
          ...
          >
            ...
            <ChevronDownIcon className="ms-2 size-4 shrink-0 text-gray-500" />
          </button>
        </PopoverTrigger>
        <PopoverPortal>
          <PopoverContent
