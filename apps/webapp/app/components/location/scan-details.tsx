...
export function ScanDetails({
  ...
  // why: compared against the literal the server writes in
  // `app/modules/scan/utils.server.ts` — never a translated string.
            ...
            <div className="flex justify-between pt-2">
              ...
              <p>
                {lastScan.manuallyGenerated
                  ...
                  : t("scanDetails.qrCodeScan")}{" "}
                <InfoTooltip
                  icon={<HelpIcon />}
                  content={
                    <>
                      <h6 className="mb-1 text-sm font-semibold text-gray-700">
                        {t("ui.sourceOfLocationData")}
                      </h6>
                      <p className="text-xs font-medium text-gray-500">
                        {t("scanDetails.twoWaysIntro")}
                      </p>
                      <ul className="text-xs font-medium text-gray-500 ">
                        <li>
                          <strong>1. Manually updated:</strong>{" "}
                          {t("scanDetails.manualUpdateExplainer")}
                        </li>
                        <li>
                          <strong>2. QR code scan:</strong>{" "}
                          {t("scanDetails.scanExplainer")}
                        </li>
                      </ul>
                    </>
                  }
