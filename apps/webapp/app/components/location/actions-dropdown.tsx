      ...
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverPortal>
          <PopoverContent
            ...
            className="order actions-dropdown static z-[99] !mt-0 w-screen rounded-b-none rounded-t-[4px] border border-gray-300 bg-white p-0 text-end md:static md:mt-auto md:w-[180px] md:rounded-t-[4px]"
          >
