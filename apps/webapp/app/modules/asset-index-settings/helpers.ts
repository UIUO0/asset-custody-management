...
export const defaultFields: Column[] = [
  ...
  { name: "quantity", visible: false, position: 14 },
  { name: "type", visible: false, position: 15 },
  { name: "assetModel", visible: false, position: 16 },
  /**
   ...
   */
  { name: "lifecycleStage", visible: false, position: 17 },
];
