  ...
  return (
    <>
      ...
      <Td className={tw("w-full min-w-[330px] p-0 md:p-0", allowCursor)}>
        <div className="flex items-center justify-between gap-3 p-4 md:pe-6">
                ...
                {isQuantityTracked(item) && item.quantity != null ? (
                  <span className="ms-2 text-xs font-normal text-gray-500">
                    ...
                    {meta && meta.maxAllowedForThisKit < item.quantity ? (
                      <span className="ms-1 text-warning-700">
          ...
          {showQtyInput ? (
            <div
              className="ms-auto flex shrink-0 flex-col items-end gap-1 pe-2"
              role="presentation"
