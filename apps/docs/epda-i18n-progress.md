...
الحصيلة الحالية: **73 نطاقاً، 3307 مفاتيح عربية / 3087 إنجليزية**.
...
فُحصت الشجرة كاملةً بثلاثة ماسحات (عُقد نصّ JSX متعددة الأسطر، خصائص JSX،
والنصوص المقتبسة داخل كود العرض). ما تبقّى من نصوص إنجليزية يقع كلّه ضمن
الاستثناءات المتّفق عليها:

- رسائل Zod والتحقّق اليدوي على العميل، ونصوص `ShelfError` و`sendNotification`.
