...
[org-i18n-and-theming.md](./org-i18n-and-theming.md) أولاً — هذا الملف يكمّله
ولا يغني عنه.
...
> (انظر [org-workflow-and-roles.md](./org-workflow-and-roles.md)) حتى لا
...
| النطاق                             | الغرض                                                     |
| ---------------------------------- | --------------------------------------------------------- |
| `availability`                     | شارات وتلميحات توفّر الأصناف والمجموعات في نطاق الحجوزات  |
| `search`                           | تسميات وتلميحات حقول البحث المشتركة بين الفهارس           |
| `bulkActions`                      | حوارات الإجراءات الجماعية وقائمة الإجراءات المنسدلة       |
| `quantity`                         | بطاقات وحوارات الأصناف المتتبَّعة بالكمية                 |
| `moveUnits`                        | حوار نقل الوحدات بين المواقع والمجموعات                   |
| `qr`                               | صفحات ربط/المطالبة برموز QR                               |
| `assetsIndex`                      | أشرطة أدوات فهرس الأصناف والفلاتر المحفوظة وإعداد الأعمدة |
| `advancedFilters`                  | حقول الفلترة المتقدمة وأعمدتها                            |
| `filterOperators`                  | معاملات المقارنة في الفلاتر (`is`، `contains`، …)         |
| `assetImport`                      | صفحة استيراد الأصناف من CSV                               |
| `assetUpdate`                      | صفحة التحديث الجماعي للأصناف من CSV                       |
| `addToBooking`                     | حوار إضافة أصناف إلى حجز قائم                             |
...
| `assetModelForm`                   | نموذج طُرز الأصناف                                        |
...
- **الأصناف** — النموذج، الفهرس، الفلاتر المتقدمة، الإجراءات الجماعية، الكمية
  والعهدة والمواضع، استيراد وتحديث CSV، وحوارات الأصناف.
...
## تنظيف هوية العلامة (قاعدة ORG) — **مكتمل 100%**
...
- قوالب CSV الثلاثة: أُعيدت تسميتها إلى `demo-example-*.csv`.
...
| `assetForm.lifecycle*`                             | حقل مرحلة الاستلام في نموذج إنشاء الصنف  |
| `requests`                                         | صفحة الطلبات `/requests`                 |
| `myCustody`                                        | صفحة الأصناف في عهدتي `/my-custody`      |
| `availableAssets`                                  | صفحة الأصناف المتاحة `/available-assets` |
