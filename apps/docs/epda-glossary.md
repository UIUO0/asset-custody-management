# معجم مصطلحات نظام إدارة الأصناف
...
| --------------- | ----------- | ------------------------------ |
| Asset           | صنف         | الوحدة الأساسية في النظام      |
| Assets          | الأصناف     |                                |
...
| In custody      | في العهدة   | حالة الصنف                     |
| Booking         | حجز         |                                |
...
| Approve and release    | اعتماد وإتاحة    | نقل الصنف إلى «جاهز للتوزيع»       |
| Send back for review   | إرجاع للمراجعة   | سحب صنف من التداول — السبب إلزامي  |
...
| My custody             | الأصناف في عهدتي | صفحة `/my-custody`                 |
| Available assets       | الأصناف المتاحة  | صفحة `/available-assets`           |
...
| English                                     | العربية                                               |
| ------------------------------------------- | ----------------------------------------------------- |
| No assets yet                               | لا توجد أصناف بعد                                     |
